...
Наследник всех своих родных.
    ...
    fun longestIncreasingSubSequence(longestIncreasingSubSequence: (List<Int>) -> List<Int>) {
        ...
        assertEquals(listOf(99), longestIncreasingSubSequence(listOf(99, 89, 79, 69, 59)))
        assertEquals(listOf(1, 2, 11, 22, 30), longestIncreasingSubSequence(listOf(1, 11, 22, 33, 2, 11, 22, 3, 4,
                30, 5)))
    }
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        assertEquals(506, shortestPathOnField("input/field_in5.txt"))
    }
